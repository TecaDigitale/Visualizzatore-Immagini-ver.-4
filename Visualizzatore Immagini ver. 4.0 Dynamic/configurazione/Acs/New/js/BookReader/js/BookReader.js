...
This file is part of BookReader.
    ...
    archive.org cvs $Revision: 1.2 $ $Date: 2011-02-15 20:25:09 $
*/
...
alert("prepareTwoPageView- 4.1");
    // Attaches to first child, so must come after we add the page view
    $('#BRcontainer').dragscrollable();
    this.bindGestures($('#BRcontainer'));
alert("prepareTwoPageView- 4.2");

alert("prepareTwoPageView- 4.2.1: "+this.twoPage);
alert("prepareTwoPageView- 4.2.2: "+this.twoPage.totalHeight);
alert("prepareTwoPageView- 4.2.3: "+this.twoPage.totalWidth);
alert("prepareTwoPageView- 4.2.4: "+$('#BRtwopageview').css);
